...
func main() {
	...
	config := pkg.AutoscalerConfig{
		...
		TaskRetryAttempts:        getEnvDefaultInt64("TASK_RETRY_ATTEMPTS", 4),
		TaskRetryMaxBackoff:      getEnvDefaultInt64("TASK_RETRY_MAX_BACKOFF", 30),
		TaskRetryMaxDuration:     getEnvDefaultInt64("TASK_RETRY_MAX_DURATION", 120),
